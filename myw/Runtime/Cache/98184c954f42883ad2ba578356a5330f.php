...
<BODY>
	<DIV id="main_frame">
		<DIV id="up_frame" class="up_frame">
			<DIV id="tool_bar" class="tool_bar">
				<DIV  id="tool_bar_m1" class="tool_bar_m">
				</DIV>
				<DIV  id="tool_bar_m2" class="tool_bar_m">
				</DIV>
				<DIV  id="tool_bar_m3" class="tool_bar_m">
				</DIV>
				<span id="title_text"><?php echo ($title); ?></span> 
				<DIV id="info_bar" class="info_bar">
					账号: <a href="#"><?php echo ($username); ?></a>&nbsp;<a href="#">设置</a>&nbsp;当前时间: <?php echo ($tdate); ?>
				</DIV>
			</DIV>
			<DIV id="progress_bar" class="progress_bar">
			</DIV>
		</DIV>
		<DIV id="midd_frame" class="midd_frame">
			<DIV id="left_bar" class="left_bar">
			</DIV>
			<DIV id="main_box" class="main_box">
				<DIV id="title_bar" class="title_bar">
				</DIV>
				<DIV id="conten_box" class="conten_box">
				</DIV>
			</DIV>
		</DIV>
		<DIV id="down_frame" class="down_frame">
		测试
		</DIV>
	</DIV>